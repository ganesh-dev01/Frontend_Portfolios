...
const Signout_ConfirmBox: React.FC<ConfirmBoxProps> = ({ isOpen, onClose, onConfirm }) => {
    if (!isOpen) return null;

    return (
        <div className={styles.confirmOverlay}>
            <div className={styles.confirmBox}>
                <p className={styles.confirmMessage}>Are you sure you want to signout?</p>
...
export default Signout_ConfirmBox;
